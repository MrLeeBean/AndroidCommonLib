...
public class XButton extends AppCompatButton {
    ...
    private void setup(AttributeSet attrs) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.XButton);
        ...
        mNormalTextColor = a.getColor(R.styleable.XButton_normalTextColor, mDefaultNormalTextColor);
        mPressedTextColor = a.getColor(R.styleable.XButton_pressedTextColor, mDefaultPressedTextColor);
        mUnableTextColor = a.getColor(R.styleable.XButton_unableTextColor, mDefaultUnableTextColor);
        setTextColor();

        //set animation duration
        mDuration = a.getInteger(R.styleable.XButton_animationDuration, mDuration);
        mStateBackground.setEnterFadeDuration(mDuration);
        mStateBackground.setExitFadeDuration(mDuration);

        //set background color
        mNormalBackgroundColor = a.getColor(R.styleable.XButton_normalBackgroundColor, 0);
        mPressedBackgroundColor = a.getColor(R.styleable.XButton_pressedBackgroundColor, 0);
        mUnableBackgroundColor = a.getColor(R.styleable.XButton_unableBackgroundColor, 0);
        ...
        //set radius
        mRadius = a.getDimensionPixelSize(R.styleable.XButton_radius, 0);
        mRound = a.getBoolean(R.styleable.XButton_round, false);
        ...
        //set stroke
        mStrokeDashWidth = a.getDimensionPixelSize(R.styleable.XButton_strokeDashWidth, 0);
        mStrokeDashGap = a.getDimensionPixelSize(R.styleable.XButton_strokeDashGap, 0);
        mNormalStrokeWidth = a.getDimensionPixelSize(R.styleable.XButton_normalStrokeWidth, 0);
        mPressedStrokeWidth = a.getDimensionPixelSize(R.styleable.XButton_pressedStrokeWidth, 0);
        mUnableStrokeWidth = a.getDimensionPixelSize(R.styleable.XButton_unableStrokeWidth, 0);
        mNormalStrokeColor = a.getColor(R.styleable.XButton_normalStrokeColor, 0);
        mPressedStrokeColor = a.getColor(R.styleable.XButton_pressedStrokeColor, 0);
        mUnableStrokeColor = a.getColor(R.styleable.XButton_unableStrokeColor, 0);
        setStroke();
