...
public class XTipDialog extends Dialog {
    ...
    public static class Builder {
         ...
         * @return 创建的 Dialog
         */
        public XTipDialog create(boolean cancelable) {
            XTipDialog dialog = new XTipDialog(mContext);
            dialog.setCancelable(cancelable);
            dialog.setContentView(R.layout.base_x_tip_dialog_layout);
            ...
            if (mCurrentIconType == ICON_TYPE_LOADING) {
                ...
                loadingView.setSize(DisplayUtils.dp2px(mContext, 32));
                ...
                if (mCurrentIconType == ICON_TYPE_SUCCESS) {
                    imageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.mipmap.base_ic_x_tip_notify_done));
                } else if (mCurrentIconType == ICON_TYPE_FAIL) {
                    imageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.mipmap.base_ic_x_tip_notify_error));
                } else {
                    imageView.setImageDrawable(ContextCompat.getDrawable(mContext, R.mipmap.base_ic_x_tip_notify_info));
                }
            ...
            if (mTipWord != null && mTipWord.length() > 0) {
                ...
                if (mCurrentIconType != ICON_TYPE_NOTHING) {
                    tipViewLP.topMargin = DisplayUtils.dp2px(mContext, 12);
                }
