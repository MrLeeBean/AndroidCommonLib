...
public class FileUtils {
     ...
     * @return
     */
    public static File saveStrToFile(String str, String path, String fileName, boolean isAppend) {
        ...
        if (hasSDCard) {
            ...
            XToast.showFailShort(BaseApplication.getInstance(), "SD卡不存在，无法存储文件！");
        }
     ...
     * @return
     */
    public static File saveBytesToFile(byte[] b, String path, String fileName, boolean isAppend) {
        String filePath = null;
        boolean hasSDCard = Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED);
        if (hasSDCard) {
            if (!TextUtils.isEmpty(path)) {
    ...
    public static void openFile(Context context, File file) {
        ...
        try {
            ...
            XToast.showInfoLong(context, "找不到打开此文件的应用");
        }
    }
    ...
    private static final String[][] MIME_MapTable = {
            ...
            {".nokia-op-base_logo", "image/vnd.nok-oplogo-color"},
